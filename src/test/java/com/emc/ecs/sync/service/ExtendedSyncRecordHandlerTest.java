...
public class ExtendedSyncRecordHandlerTest {
    ...
    public void testInsert() {
        ...
        Assert.assertEquals(query, ExtendedSyncRecordHandler.insert("foo", null));
        ...
        Assert.assertEquals(query, ExtendedSyncRecordHandler.insert("foo", params));
    }
    ...
    public void testUpdateBySourceId() {
        ...
        Assert.assertEquals(query, ExtendedSyncRecordHandler.updateBySourceId("foo", null));
        ...
        Assert.assertEquals(query, ExtendedSyncRecordHandler.updateBySourceId("foo", params));
    }
}
