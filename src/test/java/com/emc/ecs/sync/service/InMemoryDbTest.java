...
public class InMemoryDbTest {
    ...
    public void testTwoTables() {
        ...
        // verify empty table
        Assert.assertEquals(0, dbService.getJdbcTemplate().queryForObject("select count(*) from " + table2, Long.class).longValue());
        ...
        // verify only 2 rows
        Assert.assertEquals(2, dbService.getJdbcTemplate().queryForObject("select count(*) from " + table2, Long.class).longValue());
