...
public class LocalCacheFilterTest {
    ...
    public void testLocalCache() {
        ...
        Assert.assertFalse(Files.exists(Paths.get(cacheDir.getAbsolutePath(), object1.getRelativePath())));
        Assert.assertFalse(Files.exists(Paths.get(cacheDir.getAbsolutePath(), object2.getRelativePath())));
        Assert.assertFalse(Files.exists(Paths.get(cacheDir.getAbsolutePath(), object3.getRelativePath())));
        Assert.assertFalse(Files.exists(Paths.get(cacheDir.getAbsolutePath(), object4.getRelativePath())));
    }
    ...
    class VerifyCacheFilter extends AbstractFilter<AbstractConfig> {
        ...
        public void filter(ObjectContext objectContext) {
            ...
            Assert.assertTrue(Files.isRegularFile(cachePath));
        }
