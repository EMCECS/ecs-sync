...
public class ArchiveSourceTest {
    ...
    public void testTarGzip() throws Exception {
        ...
        Assert.assertEquals("Failures detected", 0, sync.getObjectsFailed());
        Assert.assertEquals("Wrong number of files transferred", 4, sync.getObjectsComplete());
        Assert.assertEquals("Wrong number of bytes transferred", 26, sync.getBytesComplete());
    }
