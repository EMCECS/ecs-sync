...
public class ArchiveStorageTest {
    ...
    public void testTarGzip() throws Exception {
        ...
        Assert.assertEquals("Failures detected", 0, sync.getStats().getObjectsFailed());
        Assert.assertEquals("Wrong number of files transferred", 3, sync.getStats().getObjectsComplete());
        Assert.assertEquals("Wrong number of bytes transferred", 26, sync.getStats().getBytesComplete());
    }
