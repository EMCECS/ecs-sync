...
import com.emc.vipr.sync.source.ArchiveFileSource;
...
public class ArchiveSourceTest {
    ...
    public void testTarGzip() throws Exception {
        ...
        source.setRootFile(new TFile(file));

        DummyTarget target = new DummyTarget();
        target.setSinkData(true);
        ...
        Assert.assertEquals("Failures detected", 0, sync.getFailedCount());
        Assert.assertEquals("Wrong number of files transferred", 4, sync.getCompletedCount());
        Assert.assertEquals("Wrong number of bytes transferred", 26, sync.getByteCount());
    }
