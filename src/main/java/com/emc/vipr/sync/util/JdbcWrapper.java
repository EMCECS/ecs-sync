...
public class JdbcWrapper {
    ...
    private Queue<Connection> threadConnectionCache = new LinkedBlockingQueue<>();
    ...
    public <T> T executeQueryForObject(String sql, Map<String, String> params, Class<T> returnType) {
        try (Connection connection = getConnection(); PreparedStatement statement = prepareStatement(connection, sql)) {
