...
public class DummyTarget extends SyncTarget {
    private static final Logger log = LoggerFactory.getLogger(DummyTarget.class);
    ...
    public Options getCustomOptions() {
        ...
        opts.addOption(Option.builder().desc(SINK_DATA_DESC).longOpt(SINK_DATA_OPTION).build());
        return opts;
    }
    ...
    public void filter(SyncObject obj) {
        ...
        if (sinkData && !obj.isDirectory()) {
            log.debug("Sinking source object {}", obj.getSourceIdentifier());
