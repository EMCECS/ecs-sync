...
public class AclMappingFilter extends SyncFilter {
    ...
    public Options getCustomOptions() {
        ...
        opts.addOption(Option.builder().longOpt(ACL_MAPPING_OPTION).desc(ACL_MAPPING_DESC)
                .hasArg().argName(ACL_MAPPING_ARG_NAME).build());
        opts.addOption(Option.builder().longOpt(APPEND_DOMAIN_OPTION).desc(APPEND_DOMAIN_DESC)
                .hasArg().argName(APPEND_DOMAIN_ARG_NAME).build());
        opts.addOption(Option.builder().longOpt(STRIP_DOMAIN_OPTION).desc(STRIP_DOMAIN_DESC).build());
        opts.addOption(Option.builder().longOpt(ADD_GRANTS_OPTION).desc(ADD_GRANTS_DESC)
                .hasArg().argName(ADD_GRANTS_ARG_NAME).build());
        opts.addOption(Option.builder().longOpt(DROP_USERS_OPTION).desc(DROP_USERS_DESC).build());
        opts.addOption(Option.builder().longOpt(DROP_GROUPS_OPTION).desc(DROP_GROUPS_DESC).build());
        return opts;
    }
