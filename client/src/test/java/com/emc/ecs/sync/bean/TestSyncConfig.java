...
public class TestSyncConfig {
    ...
    public void testMarshalling() throws Exception {
        ...
        String xml = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>" +
                "<SyncConfig>" +
                "<Source class=\"com.emc.ecs.sync.bean.JobControl\"/>" +
                "<Target class=\"com.emc.ecs.sync.bean.JobList\">" +
                "<Property name=\"a\" value=\"b\"/>" +
                "</Target>" +
                "<Filter class=\"com.emc.ecs.sync.bean.SyncConfig\">" +
                "<Property name=\"foo\" value=\"bar\"/>" +
                "</Filter>" +
                "<Filter class=\"com.emc.ecs.sync.bean.JobInfo\">" +
        ...
        object.setFilters(Arrays.asList(new PluginConfig(SyncConfig.class).addCustomProperty("foo", "bar"),
                new PluginConfig(JobInfo.class).addCustomProperty("baz", "bee").addCustomProperty("hi", "ya")));
        ...
        object.setSource(new PluginConfig(JobControl.class));
        object.setTarget(new PluginConfig(JobList.class).addCustomProperty("a", "b"));
