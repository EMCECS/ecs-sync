...
@XmlType(propOrder = {"source", "target", "filters", "queryThreadCount", "syncThreadCount",
        "recursive", "timingsEnabled", "timingWindow", "rememberFailed", "verify", "verifyOnly",
        "deleteSource", "logLevel", "dbFile", "dbTable", "splitPoolsThreshold", "metadataOnly", "ignoreMetadata",
