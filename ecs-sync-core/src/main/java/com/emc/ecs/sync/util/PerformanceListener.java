...
public class PerformanceListener implements ProgressListener {
    private PerformanceWindow performanceWindow;

    public PerformanceListener(PerformanceWindow performanceWindow) {
    ...
    public void transferred(long size) {
        performanceWindow.increment(size);
    }
}
