...
public class ObjectMetadata implements Cloneable {
    ...
    public ObjectMetadata withHttpEtag(String httpEtag) {
        setHttpEtag(httpEtag);
        return this;
    }
    ...
    public static ObjectMetadata fromJson(String json) {
        ...
        if (instanceClass == null) { // might be data from an older version; make sure user is aware
            ...
            try {
                return ((ObjectMetadata) Class.forName(instanceClass.getAsString()).getDeclaredConstructor().newInstance()).createFromJson(json);
            } catch (Exception e) {
