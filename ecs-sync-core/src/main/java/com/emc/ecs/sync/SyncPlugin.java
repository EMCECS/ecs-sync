...
import com.emc.ecs.sync.model.SyncControl;
...
public interface SyncPlugin<C> extends AutoCloseable {
     ...
     */
    void configure(SyncStorage<?> source, Iterator<? extends SyncFilter<?>> filters, SyncStorage<?> target);
    ...
    void setSyncJob(EcsSync syncJob);
}
