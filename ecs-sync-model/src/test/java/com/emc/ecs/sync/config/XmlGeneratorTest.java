...
public class XmlGeneratorTest {
    ...
    public void testBasic() throws Exception {
        String expectedXml = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"no\"?>\n" +
                ...
                "        <!-- Specifies the DB table name to use. Use this with - -db-connect-string to provide a unique table name or risk corrupting a previously used table. Default table is \"objects\" -->\n" +
                "        <!-- String -->\n" +
                ...
                "        <!-- Sets the verbosity of logging (silent|quiet|verbose|debug). Default is quiet -->\n" +
                "        <!-- LogLevel - Values: [silent, quiet, verbose, debug] - Default: quiet -->\n" +
                ...
                "        <!-- Path to a file that supplies the list of source objects to sync. This file must be in CSV format, with one object per line and the identifier is the first value in each line. This entire line is available to each plugin as a raw string -->\n" +
                "        <!-- String -->\n" +
        ...
        String generatedXml = XmlGenerator.generateXml(true, "xgs:", "xgs:");
    ...
    public void testFilters() throws Exception {
        ...
        String generatedXml = XmlGenerator.generateXml(true, "xgs:", "xgs:", "xgf", "xgf");
    ...
    public void testNoComments() throws Exception {
        ...
        String generatedXml = XmlGenerator.generateXml(false, "xgs:", "xgs:", "xgf", "xgf");
    ...
    public static class XGSConfig extends AbstractConfig {
        ...
        @Option(description = "really big number")
