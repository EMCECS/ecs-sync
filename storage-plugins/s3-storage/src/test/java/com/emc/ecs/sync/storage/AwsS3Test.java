...
public class AwsS3Test {
    ...
    public void testNormalUploadSTS() throws Exception {
        Assumptions.assumeTrue(region != null); // for now, this setting will signify that AWS is the S3 endpoint
    ...
    @Disabled // only perform this test on a co-located S3 store!
    @Test
