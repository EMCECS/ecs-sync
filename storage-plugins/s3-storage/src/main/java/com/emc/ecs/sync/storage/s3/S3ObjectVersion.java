...
public class S3ObjectVersion extends SyncObject {
    ...
    // XXX: need a better mechanism to set this property
    @Override
    public void compareSyncObject(SyncObject syncObject) {
        if (syncObject instanceof BlobSyncObject
            ...
            setProperty(AbstractS3Storage.PROP_OBJECT_SNAPSHOTS, true);
        }
    }
    ...
    public String getMd5Hex(boolean forceRead) {
        ...
        boolean isIncludedSnapshots = getProperty(AbstractS3Storage.PROP_OBJECT_SNAPSHOTS) != null;
